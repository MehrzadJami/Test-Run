...
function makeReadme(input: ModelPackageInput): string {
  ...
  lines.push(`**Generated by:** ChemEngAI  |  **Provider:** ${providerUsed}  |  **Date:** ${date}`);
...
function makeMissingInfoMd(report: ReproducibilityReport): string {
  ...
  lines.push(`_Generated by ChemEngAI reproducibility engine — ${new Date().toISOString().slice(0, 10)}_`);
  lines.push("");
...
function makeRequirementsTxt(): string {
  return [
    "# Python dependencies for ChemEngAI-generated simulation template",
...
function makeSourceExcerpt(
  ...
  const lines: string[] = [
    ...
    "=" .repeat(60),
    "Generated by ChemEngAI — these are verbatim excerpts used",
